...
<script>
  ...
  socket.on('gift_broadcast', d => {
    ...
    b.innerHTML += '<div style="color:gold; background:rgba(255,215,0,0.1); padding:4px; border-radius:6px; margin:2px 0;">🎁 <b>' + d.sender + '</b> sent ' + d.giftName + ' ' + d.giftIcon + ' to <b>' + d.target + '</b></div>';
