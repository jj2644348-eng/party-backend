...
app.post('/api/auth/gmail', (req, res) => {
  ...
  if (isOwner) {
    ...
    // नॉर्मल यूज़र की 8-अंकों की आईडी या कस्टम आईडी
    users[em] = {
...
// सॉकेट कनेक्शन (रियल-टाइम माइक, रूम और गॉड मोड)
io.on('connection', (socket) => {
  ...
  // 👑 ओनर गॉड मोड: किसी को भी कॉइन्स/वीआईपी देना
...
// कम्पलीट फ्रंटएंड UI (अरेबियन थीम + 12 माइक + 5 टैब्स)
app.get('*', (req, res) => {
